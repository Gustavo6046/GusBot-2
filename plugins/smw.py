...
@easy_bot_command("smw_forcepass", True)
def force_turn_pass(message, raw):
	global turn_index
	global turns
...
@easy_bot_command("smw_forcejoin", True)
def force_player_join(message, raw):
	global turn_index
	global turns
